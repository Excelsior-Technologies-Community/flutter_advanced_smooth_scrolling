...
class AdvancedGridView extends StatefulWidget {
  ...
  @override
  State<AdvancedGridView> createState() =>
      _AdvancedGridViewState();
}

class _AdvancedGridViewState extends State<AdvancedGridView> {
  ...
  void didUpdateWidget(
      covariant AdvancedGridView oldWidget,
      ) {
